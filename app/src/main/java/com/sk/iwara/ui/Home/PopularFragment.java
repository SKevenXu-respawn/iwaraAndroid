...
public class PopularFragment extends BaseFragment<FragmentPopularBinding> {
    ...
    protected void initUI() {
        ...
        binding.popularRecyle.setLayoutManager(new GridLayoutManager(getContext(), 2));
        binding.popularRecyle.setAdapter(adapter);
        binding.popularRecyle.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
    ...
    private void getData(){
        ...
        HttpUtil.get().getAsync(IWARA_API.getHomeVideos("popularity", 20,0), null,null, new HttpUtil.NetCallback() {
            @Override
