...
@UnstableApi
public class Anime4KChainEffect implements GlEffect {

    private  String glsl;

    public Anime4KChainEffect(Context ctx) throws IOException {
//        String mpv = readAsset(ctx, "glsl/Anime4K_Thin_Fast.glsl");
//        glsl = MpvToEs2Translator.translate(mpv, "uTexture", "uResolution");
        glsl = readAsset(ctx, "glsl/Anime4K_Thin_VeryFast.glsl");
        glsl=Anime4KTranslator.toES2(glsl);
    }
